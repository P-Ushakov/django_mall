...
class ObjDisposer(models.Model):
    name = models.CharField(max_length=50)
...
class MlObject(models.Model):
    ...
    obj_upp_expense_cat = models.CharField(max_length=10, blank=True)
    obj_parents = models.ManyToManyField('self', blank=True)
    obj_groups = models.ManyToManyField(MlGroup, blank=True)
    obj_status_id = models.ForeignKey(ObjStatus,
                                      on_delete=models.SET_NULL,
                                      blank=True,
                                      null=True,)
    obj_disposer_id = models.ForeignKey(ObjDisposer,
                                        on_delete=models.SET_NULL,
                                        blank=True,
                                        null=True,)
    obj_location = models.CharField(max_length=100, blank=True)
    description = models.CharField(max_length=2000, blank=True)
...
class MlObjectPassportKey(models.Model):
    name = models.CharField(max_length=50)
...
class MlObjPassportData(models.Model):
    ...
    ml_object_passport_key_id = models.ForeignKey(MlObjectPassportKey, on_delete=models.CASCADE)
...
class MlObjCounterParamKey(models.Model):
    name = models.CharField(max_length=50)
    units = models.CharField(max_length=10)
    upp_expense_cat = models.CharField(max_length=10, blank=True)
    description = models.CharField(max_length=500, blank=True)
...
class AddedDocs(models.Model):
    ml_object_id = models.ForeignKey(MlObject, on_delete=models.CASCADE)
    obj_doc = models.FileField()
    doc_teg = models.CharField(max_length=100, blank=True)
    doc_description = models.CharField(max_length=500, blank=True)
...
class MlObjReglament(models.Model):
    ...
    freq_type_id = models.ForeignKey(FreqType, on_delete=models.CASCADE)
...
class MlObjTaskBook(models.Model):
    ...
    task_creator = models.CharField(max_length=100, blank=True)
    ...
    task_person = models.CharField(max_length=100)
...
class MlObjServiceBook(models.Model):
    ...
    operational_description = models.CharField(max_length=500, blank=True)
