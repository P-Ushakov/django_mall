# Generated by Django 2.1.5 on 2019-01-26 17:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doc_teg', models.CharField(blank=True, max_length=100)),
                ('doc_description', models.CharField(blank=True, max_length=500)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50)),
                ('units', models.CharField(max_length=10)),
                ('upp_expense_cat', models.CharField(blank=True, max_length=10)),
                ('description', models.CharField(blank=True, max_length=500)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obj_upp_expense_cat', models.CharField(blank=True, max_length=10)),
                ('obj_location', models.CharField(blank=True, max_length=100)),
                ('description', models.CharField(blank=True, max_length=2000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ml_object_passport_key_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mall.MlObjectPassportKey')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=200)),
                ('freq_type_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mall.FreqType')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=500)),
                ('task_creator', models.CharField(blank=True, max_length=100)),
                ('operational_description', models.CharField(blank=True, max_length=500)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='mall.ObjDisposer'),
        ),
        migrations.AddField(
            model_name='mlobject',
            name='obj_groups',
            field=models.ManyToManyField(blank=True, to='mall.MlGroup'),
        ),
        migrations.AddField(
            model_name='mlobject',
            name='obj_parents',
            field=models.ManyToManyField(blank=True, related_name='_mlobject_obj_parents_+', to='mall.MlObject'),
        ),
        migrations.AddField(
            model_name='mlobject',
            name='obj_status_id',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='mall.ObjStatus'),
        ),
        migrations.AddField(
